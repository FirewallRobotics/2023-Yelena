...
public class DriveConePlacementCommand extends Command {
  ...
  public DriveConePlacementCommand(DriveSubsystem dt_subsystem, VisionSubsystem v_subsystem) {
  ...
  @Override
  public void execute() {
    adjustLeftRight = m_vision.adjustConePlacementLeftRight;
    adjustBackForward = m_vision.adjustConePlacementBackForward;
